        ...
        <div>
            ...
            <div>
                <div className="card" style={{ width: '18rem' }}>
                    <img src={macbk} className="card-img-top" alt="..." />
                    <div className="card-body">
                        ...
                        <a href="https://github.com/ohthebrave/Netfluxx-Clone.git" className="btn btn-primary">View Project</a>
                    </div>
                </div>

                <div className="card" style={{ width: '18rem' }}>
                    <img src={graffiti} className="card-img-top" alt="..." />
                    <div className="card-body">
                        ...
                        <a href="https://github.com/ohthebrave/phase-0-css-graffiti-lab" className="btn btn-primary">View Project</a>
                    </div>
                </div>
                ...
                <div className="card" style={{ width: '18rem' }}>
                    ...
                    <div className="card-body">
                        ...
                        <a href="https://github.com/ohthebrave/phase-0-css-rainbow-lab" className="btn btn-primary">View Project</a>
                    </div>
                </div>
            </div>
        </div>
